...
public:
    ...
    Node(K key,T value):height(-1),balance_factor(0),size(1),key(key),value(value),left_son(nullptr),right_son(nullptr){}
    Node():height(-1),balance_factor(0),size(0),key(nullptr),value(nullptr),right_son(nullptr),left_son(nullptr){}
...
template<class T, class K>
bool AVLtree<T, K>::Insert(K key, T value) {
